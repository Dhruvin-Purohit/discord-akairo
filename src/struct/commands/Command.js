...
class Command extends AkairoModule {
    constructor(id, options = {}) {
        ...
        /**
         * Usable only by the client developer.
         * @type {boolean}
         */
        this.developerOnly = Boolean(developerOnly)
 ...
 * @prop {boolean} [developerOnly=false] - Whether or not to allow client developer(s) only.
